 ...
 * This file demonstrates how to integrate Graphprotocol with a web frontend
 */

// For React/Vue/Angular applications
export class GraphprotocolClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new GraphprotocolClient(provider, contractAddress);
