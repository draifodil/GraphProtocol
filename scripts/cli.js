...
const contractABI = require("../artifacts/contracts/Graphprotocol.sol/Graphprotocol.json").abi;

program
    .name("graphprotocol-cli")
    .description("CLI tool for Graphprotocol smart contract")
    .version("1.0.0");
